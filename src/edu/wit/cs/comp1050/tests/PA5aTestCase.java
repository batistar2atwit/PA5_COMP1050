...
import edu.wit.cs.comp1050.IntTester;
import edu.wit.cs.comp1050.IntVector;
import junit.framework.TestCase;

public class PA5aTestCase extends TestCase {
	
	private static class IndexTester implements IntTester {
		final int i;
		
		public IndexTester(int i) {
			this.i = i;
		}

		@Override
		public boolean test(Integer idx, Integer value) {
			return idx == i;
		}
	}
	...
	private void _testRemoveAllIf(IntVector v, IntTester t, int rE, int sizeE, int capE, String sE, int[] aE) {
		Integer result;
		
		result = Integer.MAX_VALUE;
		try {
			result = v.removeAllIf(t);
		} catch (ExitException ex) {}
		assertEquals(String.format("removeAllIf return"), rE, (int) result);
	...
	public void testRemoveIf() {
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(-100), 0, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]", new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(0), 1, 8, 9, "[2, 3, 4, 5, 4, 3, 2, 1]", new int[] {2, 3, 4, 5, 4, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(1), 1, 8, 9, "[1, 3, 4, 5, 4, 3, 2, 1]", new int[] {1, 3, 4, 5, 4, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(2), 1, 8, 9, "[1, 2, 4, 5, 4, 3, 2, 1]", new int[] {1, 2, 4, 5, 4, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(3), 1, 8, 9, "[1, 2, 3, 5, 4, 3, 2, 1]", new int[] {1, 2, 3, 5, 4, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(4), 1, 8, 9, "[1, 2, 3, 4, 4, 3, 2, 1]", new int[] {1, 2, 3, 4, 4, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(5), 1, 8, 9, "[1, 2, 3, 4, 5, 3, 2, 1]", new int[] {1, 2, 3, 4, 5, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(6), 1, 8, 9, "[1, 2, 3, 4, 5, 4, 2, 1]", new int[] {1, 2, 3, 4, 5, 4, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(7), 1, 8, 9, "[1, 2, 3, 4, 5, 4, 3, 1]", new int[] {1, 2, 3, 4, 5, 4, 3, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(8), 1, 8, 9, "[1, 2, 3, 4, 5, 4, 3, 2]", new int[] {1, 2, 3, 4, 5, 4, 3, 2}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			new IndexTester(9), 0, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]", new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}
		);
		...
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			(idx,value)->true, 9, 0, 9, "[]", new int[] {}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			(idx,value)->false, 0, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]", new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			(idx,value)->idx%2==0, 5, 4, 9, "[2, 4, 4, 2]", new int[] {2, 4, 4, 2}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			(idx,value)->idx>3, 5, 4, 9, "[1, 2, 3, 4]", new int[] {1, 2, 3, 4}
		);
		
		_testRemoveAllIf(
			_construct(new int[] {1, 2, 3, 4, 5, 4, 3, 2, 1}, 9, 9, "[1, 2, 3, 4, 5, 4, 3, 2, 1]"),
			(idx,value)->(idx+value)%2==1, 9, 0, 9, "[]", new int[] {}
		);
	}
	...
	public void testIntegration() {
		...
		_testRemoveAllIf(a, (idx, value)->value%2==0, 3, 3, 10, "[1, 3, 5]", new int[] {1, 3, 5});
		...
		_testRemoveAllIf(a, (idx,value)->value%2!=0, 7, 4, 11, "[10, 20, 30, 40]", new int[] {10, 20, 30, 40});
		
		_testAddAll(a, 1, new Integer[] {11, 13, 17, 19}, 8, 11, "[10, 11, 13, 17, 19, 20, 30, 40]", new int[] {10, 11, 13, 17, 19, 20, 30, 40});
	}
